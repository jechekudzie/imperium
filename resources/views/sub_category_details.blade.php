                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <aside style="margin-top: -130px;" class="side-bar">
                            ...
                            <div class="widget widget_categories">
                                <h4 class="widget-title">{{ $subCategory->category->name }}</h4>
                                <ul>
                                    @foreach (App\Models\SubCategory::where('category_id', $subCategory->category->id)->get() as $other_sub_category)
                                        <li><a href="{{ url('/sub_category_details/' . $other_sub_category->id) }}">{{ $other_sub_category->name }}
                                            </a> &nbsp;</li>
                                    @endforeach
                                                ...
                                                <div class="tab-content">
                                                    <div id="web-design-1" class="tab-pane active">
                                                        <p>
                                                            ...
                                                            {!! substr($subCategory->description, 0, 700) !!} ..... <a class="site-button"
                                                                data-bs-toggle="modal" href="#staticBackdrop"
                                                        ...
                                                        <div class="col-lg-4 col-sm-12 m-b30 product-item card-container">
                                                            <div class="dez-box">
                                                                <div class="dez-thum-bx dez-img-effect">
                                                                    <img style="width: 500px; height:306px" src="{{ $product->image!=null ? asset($product->image) : '/website/images/our-services/service-4/pic1.jpg' }}"
                                                                        alt="">
