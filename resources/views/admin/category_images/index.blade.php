                                    ...
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        @foreach($categoryImages as $categoryImage)
                                            <tr>
                                                ...
                                                <td class="owner">{{$categoryImage->name}}</td>
                                                <td class="owner"><img width="100" height="100" src="{{asset($categoryImage->image)}}"/></td>
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a class="edit-item-btn"
                                                               href="{{url('/admin/category_images/'.$categoryImage->id.'/edit')}}">Edit <i
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            title="Edit">
                                                            <a class="edit-item-btn"
                                                               href="{{url('/admin/category_images/'.$categoryImage->id.'/edit')}}">View </a>
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
                            ...
                            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        ...
                                        <form method="post" action="{{ url('/admin/category_images') }}" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="file" name="image[]" multiple class="form-control rounded-pill mb-3">
                                                        </div>
