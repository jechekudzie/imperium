            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{$subCategory->name}} Category</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">CRM</a></li>
                                <li class="breadcrumb-item active">{{$subCategory->name}} Category</li>
                            </ol>
                        </div>
                            ...
                            <!--end add modal-->
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        <form method="post" action="{{url('/admin/sub_categories/'.$subCategory->id)}}" enctype="multipart/form-data">
                                            @method('PUT')
                                            @csrf
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div>
                                                            <label for="companyname-field"
                                                                   class="form-label">{{$subCategory->name}} category</label>
                    ...
                    <div class="card" id="companyList">
                        ...
                        <div class="card-body">
                            <!--end add modal-->
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        <img src="{{asset($subCategory->image)}}" style="width: 300px;">
                                    </div>
                                </div>
                        </div>
                    </div>
