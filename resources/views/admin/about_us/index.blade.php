                            ...
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <button class="btn btn-info add-btn" data-bs-toggle="modal"
                                            ...
                                            class="ri-add-fill me-1 align-bottom"></i> Add About Us
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive table-card mb-3">
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="name" scope="col">Page Banner</th>
                                            <th class="sort" data-sort="name" scope="col">About us</th>
                                        ...
                                        @foreach($about_us as $about)
                                            <tr>
                                                ...
                                                <td class="owner"><img width="150" height="100" src="{{asset($about->image)}}"/></td>
                                                <td class="owner">{!! substr($about->description,0,150) !!}</td>
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a class="edit-item-btn"
                                                               href="{{url('/admin/about_us/'.$about->id.'/edit')}}">Edit <i
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        <div class="modal-header bg-soft-info p-3">
                                            <h5 class="modal-title" id="exampleModalLabel">Add About Us Page</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close" id="close-modal"></button>
                                        </div>
                                        <form method="post" action="{{url('/admin/about_us')}}"
                                            ...
                                            <div class="modal-body">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div>
                                                            <label for="name"
                                                                   class="form-label">Page Banner</label>
