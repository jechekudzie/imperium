                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        <a href="{{url('/')}}" class="logo logo-dark">
                            ...
                            <span style="color: white;">Imperium Administration</span>
                        </a>
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <span class="d-flex align-items-center">
                            <span class="text-start ms-xl-2">
                                ...
                                <span
                                    class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Imperium Administration</span>
                            </span>
                        </span>
                        </button>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarDashboards">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{url('/admin/brands')}}" class="nav-link active" data-key="t-analytics">
                                        PRODUCT BRANDS </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('/admin/products')}}" class="nav-link"
                                       data-key="t-ecommerce"> PRODUCTS </a>
                                </li>
