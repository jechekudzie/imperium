...
<body id="bg">
    ...
    <div class="page-wraper">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-3">
                            <div class="logo-header "><a href="index.html"><img
                                        src="{{ asset('logo/logo-01 copy.png') }}" width="193" height="89"
                                        alt=""></a></div>
                        </div>
                        <div class="col-xl-8 col-lg-9">
                            <ul class="contact-info clearfix">
                                <li>
                                    ...
                                    <span>+263 242 255453, +263 773 937032</span>
                                </li>
                                <li>
                            ...
                            <div class="header-nav navbar-collapse collapse" id="navbarNavDropdown">
                                <ul class="nav navbar-nav">
                                    ...
                                    @foreach (\App\Models\Category::all() as $category)
                                        <li><a href="{{ url('/sub_categories/' . $category->id) }}">{{ $category->name }}<i
        ...
        <footer class="site-footer">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="widget widget_about">
                                ...
                                <ul class="dez-social-icon">
                                    <li class="border"><a class="fab fa-facebook-f" href="javascript:void(0);"></a>
                                    </li>
                                    <li class="border"><a class="fab fa-twitter" href="javascript:void(0);"></a></li>
                                    <li class="border"><a class="fab fa-linkedin-in" href="javascript:void(0);"></a>
                                    </li>
                                    <li class="border"><a class="fab fa-facebook-f" href="javascript:void(0);"></a>
                                    </li>
                                </ul>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="widget widget_getintuch">
                                ...
                                <ul>
                                    <li><i class="fas fa-map-marker-alt"></i><strong>address</strong> address comes
                                        here
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center"><span>© copyright {{ date('Y') }} by Imperium Branding.
    ...
    <script src="{{ asset('website/plugins/revolution/revolution/js/extensions/revolution.extension.actions.min.js') }}">
    </script>
    <script src="{{ asset('website/plugins/revolution/revolution/js/extensions/revolution.extension.carousel.min.js') }}">
    </script>
    <script src="{{ asset('website/plugins/revolution/revolution/js/extensions/revolution.extension.kenburn.min.js') }}">
    </script>
    <script
        src="{{ asset('website/plugins/revolution/revolution/js/extensions/revolution.extension.layeranimation.min.js') }}">
    </script>
    <script
        src="{{ asset('website/plugins/revolution/revolution/js/extensions/revolution.extension.navigation.min.js') }}">
    </script>
    <script src="{{ asset('website/plugins/revolution/revolution/js/extensions/revolution.extension.parallax.min.js') }}">
    </script>
    <script
        src="{{ asset('website/plugins/revolution/revolution/js/extensions/revolution.extension.slideanims.min.js') }}">
    </script>
    <script src="{{ asset('website/plugins/revolution/revolution/js/extensions/revolution.extension.video.min.js') }}">
    </script>
