...
<head>
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/color15.css') }}" media="screen" id="color">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/custom_styles.css') }}" media="screen" id="color">
...
<header id="stickyheader">
    ...
    <!-- This is where logo and cart is -->
                ...
                <span class="sm-nav-btn">
                  <i class="fa fa-bars"></i>
                        ...
                        <div class="brand-logo logo-sm-center">
                            <a href="{{url('/')}}">
                                <img src="{{asset('assets/logo/logo-01 copy.png')}}" width="250"
    ...
    <!-- This is where the main menu is. -->
                ...
                <div class="col-12">
                    <div class="navbar-menu">
                        <div class="logo-block">
                            <div class="brand-logo logo-sm-center">
                                <a href="{{url('/')}}">
                                    <img src="{{asset('assets/logo/logo-02.jpg')}}" class="img-fluid  " alt="logo">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="menu-block">
                            <nav id="main-nav">
                                ...
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                    ...
                                    <!--HOME-->
                                    <li>
                                        <a class="dark-menu-item" href="{{url('/')}}">Home</a>
                                    </li>
                                    <!--HOME-END-->

                                    <!--PRODUCTS-->
                                    <li>
                                        <a class="dark-menu-item" href="{{url('/products')}}">Products</a>
                                    ...
                                    <!--PRODUCTS-->
                                    <li>
                                        <a class="dark-menu-item" href="#">Services</a>
                                        <ul>
                                    ...
                                    <!--ABOUT-->
                                    <li>
                                        <a class="dark-menu-item" href="{{url('/about_us')}}">About Us</a>
                                    </li>
                                    <!--ABOUT-END-->

                                    <!--GALLERY-->
                                    <li>
                                        <a class="dark-menu-item" href="{{url('#')}}">Gallery</a>
                                    </li>
                                    <!--GALLERY-END-->

                                    <!--CONTACT-->
                                    <li>
                                        <a class="dark-menu-item" href="{{url('/contact_us')}}">Contact Us</a>
                                    </li>
                                    <!--CONTACT-END-->
...
<section class="subscribe1 ">
    <img src="../assets/images/marketplace/subscribe2.png" alt="subscribe" class="bg-img img-fluid">
    <div class="container">
        <div class="row">
            <div class="col-12">
...
<!-- footer start -->
<footer>
    <div class="footer1 section-mb-space">
        <div class="container">
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="footer-box">
                            ...
                            <div class="footer-contant">
                                <div class="footer-logo">
                                    <a href="{{url('/')}}">
                                        <img src="{{asset('assets/logo/logo-02.jpg')}}" class="img-fluid"
                                             style="width: 350px; height: 200px;" alt="logo">
                                    </a>
                                </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-md-8 col-sm-12">
                    <div class="footer-left">
                        <p>{{date('Y')}} &copy; Imperium Branding - >  <a style="color:white;" href="https://leadingdigital.africa/" target="_blank">Designed By Leading Digital</a></p>
                    </div>
                </div>
                <div class="col-xl-6 col-md-4 col-sm-12">
                    <div class="footer-right">
                        <ul class="sosiyal">
                            <li><a href="https://www.facebook.com/imperiumbranding"><i class="fa fa-facebook"></i></a></li>
